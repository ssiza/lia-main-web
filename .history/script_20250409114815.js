...
/*************  ✨ Windsurf Command 🌟  *************/
    /**
     * Closes the mobile menu if it is currently active.
     * @param {HTMLElement} hamburger - The hamburger button element.
     * @param {HTMLElement} navMobile - The mobile navigation menu element.
    ...
    function closeMobileMenu(hamburger, navMobile, overlay) {
        ...
        if (navMobile && navMobile.classList.contains('active')) {
            ...
            // Remove 'active' class from mobile navigation menu
...
/*******  0d52d2cb-d948-4e24-8d32-700bfac5ec22  *******/
